...
const Navbar = () => {
  ...
  return (
    <div className=" flex items-center justify-between py-3 font-medium ">
      <Link to="/">
        <img className="h-44" src={assets.logo} alt="" />
      </Link>
      ...
      <ul className=" sm:flex gap-5 text-sm text-gray-700 hidden">
        ...
        <NavLink
          to="/contact"
          className="flex flex-col item-cent hideener gap-1"
        >
          <p>CONTACT</p>
          <hr className="w-2/4 border-none h-[1.5px] bg-gray-700 hidden" />
        </NavLink>
      ...
      <div className="flex items-center gap-6">
        ...
        <Link to="/cart" className="relative">
          ...
          <p className="absolute right-[-5px] bottom-[-5px] w-4 text-center leading-5 bg-black text-white aspect-square rounded-full text-[9px] ">
            {getCartCount()}
          </p>
        </Link>
